function Footer() {
  return (
    <div className="bg-transparent border-t-2 border-t-gray-600 mx-2 sm:mx-5 flex flex-col justify-center py-7 items-center">
      <div className="mb-4 text-center w-full flex justify-center">
          <p className="flex flex-wrap w-[80%] text-center text-gray-500">Thank you for taking the time to visit my portfolio. Your interest and support mean the world to me. I hope you enjoyed exploring my work as much as I enjoyed creating it. Let&apos;s stay connected and keep inspiring each other!</p>
      </div>
